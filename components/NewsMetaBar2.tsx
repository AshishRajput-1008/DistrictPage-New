...
export default function NewsMetaBar2({
    newsCategory,
    newsCatinhindi,
    newsSubCategory,
    newsSlug,
    ...
    const categoryPageUrl = subcategorySlug
        ? `/mera-district/local/${categorySlug}/${subcategorySlug}`
        : `/mera-district/local/${categorySlug}`;

    const newsUrl = subcategorySlug
        ? `/mera-district/local/${categorySlug}/${subcategorySlug}/news/${newsSlug}`
        : `/mera-district/local/${categorySlug}/news/${newsSlug}`;
