...
export default function VideoNews() {
    ...
    const videoNews = [
        {
            image: "https://mapi.sadaivsatya.com/Media/NewsThumb/5wikkaqq5hg.webp",
            headline: "कांग्रेस की SIT से बड़ी बैठक",
            duration: "5:30",
        },
        {
            image: "https://mapi.sadaivsatya.com/Media/NewsThumb/poqmjagyzp3.webp",
            headline: "महिलाओं का शराब विरोधी आंदोलन",
            duration: "8:45",
        },
        {
            image: "https://mapi.sadaivsatya.com/Media/NewsThumb/qortwxzmhkv.webp",
            headline: "बजट पर डिंपल यादव का हमला",
            duration: "6:20",
        },
        {
            image: "https://mapi.sadaivsatya.com/Media/NewsThumb/wab2q13m2my.webp",
            headline: "चंद्रशेखर आज़ाद की संसद में दहाड़",
            duration: "4:15",
        },
    ];
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                    {videoNews.map((video, idx) => (
                        <div key={idx} className="group cursor-pointer">
                            ...
                            <h3 className="font-semibold text-xs sm:text-sm leading-tight group-hover:text-[#b30000] transition-colors line-clamp-2">
                                {video.headline}
                            </h3>
                        </div>
                    ))}
