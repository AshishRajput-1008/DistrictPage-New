                ...
                <div className="space-y-4">
                    {stackedNews.map((news, idx) => (
                        <div key={idx}>
                                ...
                                <CardContent className="p-0">
                                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                                        ...
                                        <div className="p-4 flex-1">
                                            <div className="flex items-center gap-2 text-[14px] md:text-[13px]  text-gray-500 mb-2 sm:mb-2">
                                                <span>{timeAgoInHindi(news.updatedDate)}</span>
                                            </div>
                                            <h3 className="font-bold text-base sm:text-lg mb-2 leading-tight hover:text-[#b30000] cursor-pointer transition-colors">
                                                {news.newsHeading}
                                            </h3>
                            ...
                            {idx === 1 && (
                                <div className="bg-gradient-to-r from-gray-200 to-gray-300 rounded-lg p-4 sm:p-6 my-4 text-center border-2 border-dashed border-gray-400">
                                    <img
