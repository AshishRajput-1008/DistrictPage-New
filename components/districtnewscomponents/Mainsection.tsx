...
export default function Mainsection() {
    ...
    const sportsNews = allNewsData.filter(
        (news) => news.newsCategory === "Sports News",
    );
    const businessNews = allNewsData.filter(
        (news) => news.newsCategory === "India" || news.newsCategory === "Crypto",
    );
    ...
    const crimeNews = allNewsData.filter(
        (news) => news.newsCategory === "World of Crimes",
    );
            ...
            <div className="mb-8 md:mb-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6">
                    ...
                    <div className="lg:col-span-3">
                        {/* Advertisement Banner Above Sports Section */}
                        ...
                        <div className="bg-white border-t-4 border-gray-900 p-3 md:p-3 md:pr-0 mb-4 md:mb-6">
                            <h3 className="text-xl md:text-xl font-black mb-4 md:mb-4 pb-2 border-b-2 border-gray-900 text-gray-900">
                                खेल समाचार
                            </h3>
                            ...
                            {sportsNews[0] && (
                                <div className="mb-3 md:mb-4">
                                    ...
                                    <div className="flex items-center justify-between text-[12px] md:text-xs text-gray-600 mb-2 mt-2">
                                        <span>{formatDate(sportsNews[0].updatedDate)}</span>
                                        <span className="flex items-center gap-1">
                                            <Eye className="w-4 h-4" />
                                            {sportsNews[0].viewCount}
                                        </span>
                                    </div>
                                    <h4 className="text-[20px] md:text-[17px] font-medium md:font-medium text-gray-900 leading-wide mb-2 hover:text-[#565ee1] cursor-pointer">
                                        <span className="text-[#565ee1]">
                                    ...
                                    <div className="flex flex-row sm:flex-row justify-between gap-1 sm:gap-0 text-[11px] md:text-[13px] text-gray-500 opacity-80 mt-2">
                                        ...
                                        <ShareButtons
                                            shareUrl={sportsNews[0].newsSlug}
                                            size="small"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="space-y-3 md:space-y-3">
                                {sportsNews.slice(0, 5).map((news) => (
                                    <div
                                        key={news.newsId}
                                        className="bg-white p-2 md:p-3 shadow-sm hover:shadow-md transition-shadow border-l-4 border-gray-900"
                                    >
                                        <div className="flex gap-2 mb-2">
                                            {/* Left side - Tag and Heading */}
                                            <div className="flex-1 min-w-0">
                                                <h5 className="text-[17px] md:text-[15px] ml-1 leading-wide font-medium md:font-medium text-gray-900 line-clamp-3 md:line-clamp-4 hover:text-[#565ee1] cursor-pointer mb-2">
                                                    <span className="text-[#565ee1]">
                                                        {news.newsTag}:
                                                    </span>{" "}
                                                    {news.newsHeading}
                                                ...
                                                {/* News Meta Bar - Below heading on left */}
                                            ...
                                            {/* Right side - Image and Share Button */}
                    ...
                    <div className="lg:col-span-6">
                        <div className="bg-white p-3 md:p-4 shadow-lg border-t-4 border-[#000000] md:border-[#000000]">
                            <h3 className="text-xl md:text-2xl font-black mb-4 md:mb-6 pb-2 border-b-4 md:border-b-2 border-[#000000] text-gray-900">
                                और खबरें
                            </h3>

                            <div className="space-y-3 md:space-y-4">
                                {crimeNews.slice(0, 3).map((news) => (
                                    <div
                                        key={news.newsId}
                                        className="bg-gray-50 p-3 md:p-4 transition-colors border-l-4 border-[#292929] hover:border-[#000000]"
                                    >
                                        <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                                            <div className="flex-1">
                                                ...
                                                <h4 className="text-[19px] md:text-lg font-medium text-gray-900 hover:text-[#ff004f] cursor-pointer mb-2 leading-tight">
                            ...
                            {/* Vertical Advertisement - Added below news */}
                    ...
                    <div className="lg:col-span-3">
                        {/* Business Section */}
                        <div className="bg-gray-100 border-t-4 border-gray-900 p-3 md:p-4 mb-4 md:mb-6">
                            <h3 className="text-lg md:text-xl font-black mb-3 md:mb-4 pb-2 border-b-4 md:border-b-2 border-gray-900 text-gray-900">
                                कारोबार
                            </h3>
                            <div className="space-y-3 md:space-y-4">
                        ...
                        <div className="border-t-4 border-[#000000] p-3 md:p-4">
                            <h3 className="text-lg md:text-xl font-black md:mb-4 pb-2 border-b-4 md:border-b-2 border-gray-900 text-gray-900 mb-5">
                                रंगीन पर्दा
                            </h3>
                            ...
                            {entertainmentNews[0] && (
                                <div className="mb-3 md:mb-4">
                                    ...
                                    <div className="flex flex-row sm:flex-row justify-between gap-1 sm:gap-0 text-[11px] md:text-[13px] text-gray-500 opacity-80">
                                        ...
                                        <ShareButtons
                                            shareUrl={entertainmentNews[0].newsSlug}
                                            size="small"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="space-y-2 md:space-y-3">
                                {entertainmentNews.slice(1, 3).map((news) => (
                                    <div
                                        key={news.newsId}
                                        className="bg-white p-2 md:p-3 md:pr-0 shadow-sm hover:shadow-md transition-shadow border-l-4 border-black"
                                    >
