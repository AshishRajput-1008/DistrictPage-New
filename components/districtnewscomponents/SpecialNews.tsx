...
export default function SpecialNews() {
    ...
    const politicsNews = allNewsData.filter(
        (news) => news.newsCategory === "Politics",
    );
    const socialNews = allNewsData.filter(
        (news) => news.newsCategory === "Social",
    );
    const taazaNews = [...politicsNews, ...socialNews].slice(0, 8);
    ...
    // LIVE UPDATES
    const taazaLiveUpdates = taazaNews.slice(0, 8).map((news) => ({
        time: getTimeAgo(news.updatedDate),
        text: news.newsHeading,
    }));

    const [currentTime, setCurrentTime] = useState<Date | null>(null);
    const [mounted, setMounted] = useState(false);
    const districtName = "भोपाल";
    const stateName = "मध्य प्रदेश";
    ...
    const heroNews = {
        ...
        newsSlug:
            "ola-uber-rapido-drivers-nationwide-strike-all-india-breakdown-10113631.html",
        thumbnail:
            "http://localhost:3000/_next/image?url=https%3A%2F%2Fmapi.sadaivsatya.com%2FMedia%2FNewsImage%2F5uey4qo1omb.webp&w=1920&q=75",
        updatedDate: "2026-02-06T15:58:10.003",
        catNameInHindi: "सामाजिक",
        subCatNameInHindi: "सामाजिक मुद्दे",
        viewCount: 341,
        ...
        // Hero specific field (optional for layout)
        summary:
            "Ola, Uber और Rapido ड्राइवर्स ने देशव्यापी हड़ताल का ऐलान किया है। इस हड़ताल का असर परिवहन सेवाओं पर पड़ सकता है और कई शहरों में यात्रियों को परेशानी का सामना करना पड़ सकता है।",
    };
    ...
    const stackedNews = [
        {
            ...
            subCatNameInHindi: "शिक्षा",
            shortDescription:
                "एमपी बोर्ड परीक्षा 2026 में 16.60 लाख से अधिक छात्र शामिल होंगे। परीक्षा को लेकर नई गाइडलाइन और OMR एंट्री समय जारी किया गया है।",
            viewCount: 413,
            dataType: "IMAGE",
        },
        {
            ...
            subCatNameInHindi: "हिंसक अपराध",
            shortDescription:
                "राजधानी में सीरियल अटैक की घटना के बाद छात्राओं में दहशत का माहौल है। पुलिस ने आरोपी को गिरफ्तार कर जांच तेज कर दी है।",
            viewCount: 347,
            dataType: "IMAGE",
        },
        {
            ...
            subCatNameInHindi: "प्रौद्योगिकी",
            shortDescription:
                "PSLV मिशन की विफलताओं को लेकर सरकार सतर्क है। पीएम के निर्देश पर VSSC का दौरा कर तकनीकी रिपोर्ट की समीक्षा की गई।",
            viewCount: 524,
            dataType: "IMAGE",
        },
        {
            ...
            subCatNameInHindi: "सामाजिक मुद्दे",
            shortDescription:
                "किराया दर और कमीशन को लेकर Ola, Uber और Rapido ड्राइवर्स ने देशव्यापी हड़ताल का ऐलान किया है। यात्रियों को परेशानी हो सकती है।",
            viewCount: 341,
            dataType: "IMAGE",
        },
    ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
                ...
                <div className="lg:col-span-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {stackedNews.slice(0, 3).map((news, idx) => (
                            <Card
                                key={idx}
                            ...
                            >
                                ...
                                <div className="flex justify-between text-[13px] text-gray-500 opacity-80 px-2">
                                    <NewsMetaBar
                                        variant="solid"
                                        newsCategory={heroNews.newsCategory}
                                        newsCatinhindi={heroNews.catNameInHindi}
                                        newsSubCategory={heroNews.newsSubCategory}
                                        newsSlug={heroNews.newsSlug}
                                    />

                                    <ShareButtons
                                        shareUrl={heroNews.newsSlug}
                                        size="small"
                                    />
                                </div>
                            </Card>
                        ...
                        {stackedNews.slice(0, 2).map((news, idx) => (
                            <Card
                                key={idx + 3}
                                className="overflow-hidden hover:shadow-xl transition-all hover:-translate-y-1 border-0 shadow-md"
                            >
                                <div className="relative">
                                    <img
                                        src={apiBaseUrl + news.thumbnail}
                ...
                {/* RIGHT: TRENDING IN BHOPAL */}
                <div className="lg:col-span-4 mt-8 md:mt-12">
                    {stackedNews.slice(0, 3).map((news, idx) => (
                        <Card
                            key={idx}
                            ...
                            <CardContent className="p-0">
                                <div className="flex gap-3">
                                    ...
                                    <div className="p-3 flex-1">
                                        ...
                                        <p>{timeAgoInHindi(news.updatedDate)}</p>
                    ...
                    {/* AD BANNER BELOW TRENDING - Resized to match left card height */}
                    <div className="mt-6">
                        <Card className="overflow-hidden border-0 shadow-md bg-gray-50 relative">
                            <div className="absolute top-3 right-3 bg-white/90 px-2 py-1 rounded text-[10px] text-gray-600 font-medium z-10">
                                विज्ञापन
